...
do
    python generate_measurement.py --model_config configs/model_config.yaml --diffusion_config configs/diffusion_ddim1000_config.yaml --task_config "$yaml_file" --gpu 7 --data_root "$data_root"
done
