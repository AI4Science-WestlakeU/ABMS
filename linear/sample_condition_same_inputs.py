...
def main():
    ...
    parser.add_argument('--n_guidance_directions', type=int, default=10)
    ...
    if cond_config['method'] in ['mcg', 'ps']:
        cond_config['params']['scale'] = args.guidance_scale
    if cond_config['method'] in ['ours_full']:
        cond_config['params']['n_guidance_directions'] = args.n_guidance_directions
