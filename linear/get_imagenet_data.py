...
HUGGINGFACE_DATASET_NAME = "your/dataset/name" # find your imagenet 256 dataset name on huggingface
...
dataset = load_dataset(HUGGINGFACE_DATASET_NAME, split="validation", cache_dir="./cache")
...
output_dir = "./data/imagenet_256_subset@1k"
