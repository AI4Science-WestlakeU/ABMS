...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--overwrite", type=bool, default=True, help="overwrite existing results"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--guidance_rate", type=float, default=0.05
    )
    parser.add_argument(
    ...
    args.image_folder = os.path.join(
        ...
        args.image_folder+"_"+args.method+"_t@"+str(args.timesteps)+"_stop@"+str(args.stop)+"_rho@"+str(args.rho_scale)+"_guidance@"+str(args.guidance_rate)
    )
    ...
    if not os.path.exists(args.image_folder):
        ...
        if not args.ni:
            ...
            if response.upper() == "Y":
                ...
                os.makedirs(args.image_folder)
        elif args.ni and args.overwrite:
            pass
        elif args.ni and not args.overwrite:
